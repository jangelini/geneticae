# geneticae ![](reference/figures/baseplot.png)
...
![Figure: comparison of cultivar performance in a selected
environment.](reference/figures/README-unnamed-chunk-4-1.png "Figure: comparison of cultivar performance in a selected environment.")
