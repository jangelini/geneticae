...
[this](https://github.com/jangelini/Geneticae-Shiny-Web-APP) Shiny app, making
...
"Selected Environment"` and the name of one environment in `selectedE` a line
that passes through the environment marker , i.e. OA93, and the biplot origin is
added, and the most suitable cultivars for that particular environment can be
identify looking at the proyection of them onto this axis. Thus, at OA93, the
highest-yielding cultivar was _Zav_, and the lowest-yielding cultivar was _Luc_.
The perpendicular line to the OA93 axis separates genotypes that yielded above
