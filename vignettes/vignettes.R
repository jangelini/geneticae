...
## ---- fig.align='center', fig.cap='Figure 3: basic biplot', tidy=TRUE---------
GGEPlot(GGE1, type="Biplot", footnote = F, titles = F)

## ---- fig.align='center', fig.cap='Figure 4: comparison of cultivare performance in a selected environment (OA93)', tidy=TRUE----
GGEPlot(GGE1, type="Selected Environment", selectedE = "OA93", footnote = F, titles = F)

## ----  fig.align='center', fig.cap='Figure 5: comparison of the performance of cultivar Luc in different environments', tidy=TRUE----
GGEPlot(GGE1, type="Selected Genotype", selectedG = "Luc", footnote = F, titles = F)

## ----  fig.align='center', fig.cap='Figure 6: comparison of two cultivars, Kat and Cas', tidy=TRUE----
GGEPlot(GGE1, type="Comparison of Genotype", selectedG1 = "Kat", selectedG2 = "Cas", footnote = F, titles = F, axis_expand = 1.5)

## ----  fig.align='center', fig.cap='Figure 7: polygon view of the GGE biplot, showing which cultivar yielded best in which environments', tidy=TRUE----
GGEPlot(GGE1, type="Which Won Where/What", footnote = F, titles = F, axis_expand = 1.5)



## ----  fig.align='center', fig.cap='Figure 8: average environement view of the GGE biplot based on genotype-focused scaling, showing mean yield and stability of genotypes', tidy=TRUE----
data<-yan.winterwheat
...
## ----  fig.align='center', fig.cap='Figure 9: Classification of genotypes with respect to the ideal genotype', tidy=TRUE, warning=FALSE----
GGEPlot(GGE1, type="Ranking Genotypes", footnote = F, titles = F)

## ----  fig.align='center', fig.cap='Figure 10: Relationship between environments', tidy=TRUE----
...
## ----  fig.align='center', fig.cap='Figure 11: Classification of environments with respect to the ideal environment', tidy=TRUE----
