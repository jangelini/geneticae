...
```{r, echo=F, fig.align='center', fig.cap='Figure: Comparison of cultivar performance in a selected environment (OA93). The scaling method used is symmetrical singular value partitioning (by default). The 78% of G + GE variability is explained by the first two multiplicative terms.'}
library(geneticae)
