...
The `geneticae` package can be used through [this](https://github.com/jangelini/Geneticae-Shiny-Web-APP) Shiny app, making it available not only for R programmers.

<!-- The `geneticae` package can be used through [this](https://geneticae.shinyapps.io/geneticae-shiny-web-app/) Shiny app, making it available not only for R programmers. Also available at [Github](https://github.com/jangelini/Geneticae-Shiny-Web-APP) and at [CEFOBI-CONICET](https://www.cefobi-conicet.gov.ar/bases-de-datos-y-programas/). -->
