...
* _yan.winterwheat_ dataset: yield of 18 winter wheat varieties grown at nine environments in Ontario in 1993. No replications are available in the data. This dataset was obtained from the `agridat` package.
...
* _plrv_ dataset: yield, plant and plot weight of 28 clones from the potato leafroll virus (PLRV) population evaluated in six environments. Replications are available in the data. This dataset was obtained from the `agricolae` package.
...
When there __no repetitions__ available in the dataset, as is the case of _yan.winterwheat_ dataset, the GGE model is indicated as follows:
