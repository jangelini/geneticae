#' Produces the site regression model from a 2-way table of
#' means
#'
#'The site regression (SREG) model also named genotype plus genotype-by-environment (GGE) model is powerful a tools for effective analysis and interpretation of multienvironment data structure
#'in breeding programs.This function is a modification of \emph{GGEModel} of GGEBiplots package.
#'
